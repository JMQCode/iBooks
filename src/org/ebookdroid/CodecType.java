...
public enum CodecType {
    ...
    TXT(EpubContext.class, Arrays.asList("txt"), Arrays.asList("text/plain", "text/*")),
    
    CHM(EpubContext.class, Arrays.asList("chm"), Arrays.asList("application/epub+zip")),
    
    UMD(EpubContext.class, Arrays.asList("umd"), Arrays.asList("application/epub+zip")),
