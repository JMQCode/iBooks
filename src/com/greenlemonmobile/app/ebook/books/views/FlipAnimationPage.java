 ...
 * @author harism
 */
public class FlipAnimationPage {
	 ...
	 */
	private Bitmap getTexture(Bitmap bitmap, RectF textureRect, int blankColor) {
	    try {
    		...
    		Bitmap bitmapTex = Bitmap.createBitmap(newW, newH, bitmap == null ? Bitmap.Config.ARGB_8888 : bitmap.getConfig());
	...
	public Bitmap getTexture(RectF textureRect, int side) {
		switch (side) {
		case SIDE_FRONT:
			return getTexture(mTextureFront, textureRect, mColorFront);
		default:
			return getTexture(mTextureBack, textureRect, mColorBack);
		}
	}
	...
	public boolean hasBackTexture() {
		return mTextureFront != null && !mTextureFront.equals(mTextureBack);
	}
