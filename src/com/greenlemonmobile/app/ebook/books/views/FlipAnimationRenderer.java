...
public class FlipAnimationRenderer implements GLSurfaceView.Renderer {
	...
	private Vector<FlipAnimationMesh> mCurlMeshes;
	private RectF mMargins = new RectF();
	private FlipAnimationRenderer.Observer mObserver;
	// Page rectangles.
	 ...
	 * Basic constructor.
	 */
	public FlipAnimationRenderer(FlipAnimationRenderer.Observer observer) {
		mObserver = observer;
		mCurlMeshes = new Vector<FlipAnimationMesh>();
	 ...
	 */
	public synchronized void addCurlMesh(FlipAnimationMesh mesh) {
		removeCurlMesh(mesh);
	 ...
	 */
	public synchronized void removeCurlMesh(FlipAnimationMesh mesh) {
